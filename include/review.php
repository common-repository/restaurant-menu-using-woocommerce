...
v1.0.0
*/
if(!class_exists('pisol_restaurant_menu_review')){
class pisol_restaurant_menu_review{
...
new pisol_restaurant_menu_review('Restaurant menu plugin', 'restaurant-menu-using-woocommerce');
}